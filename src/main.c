...
main (int argc, char *argv[])
{
    ...
    if (1 == argc)
    {
        /* -E> safe MC3R1.R17.7 2 If fprintf() fails there is little we can do besides returning 1. */
     ...
     */
    /* -E> safe MC3R1.R1.1 1 This tagging comment is a relic of past */
    ...
    {
        /* -E> safe MC3.D4.6 1 This tagging comment refers the wrong rule id */
